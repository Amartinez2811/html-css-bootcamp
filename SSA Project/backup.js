...
$(document).ready(function(){
           ...
           $("#ssn").mask("999-99-9999");
            ...
            $("#uninc, #eninc").keypress(function(event) {
...
var month, year, state, type, payment;
...
$("#fedla").change(function() {
    ...
    if (state == null) {
            ...
            $("#fedla").find("option:selected").removeAttr("selected");
                ...
                switch(parent1){ //using switch compare selected option and populate child
    ...
    else if ((month <= 9) && (year <= "2014") && (state == "NY")) {
    ...
    else if ((10 >= month <= 12) && (year >= "2014") && (state == "NY") || (year >= "2015") && (state == "NY")) {
        ...
        $('#note').hide();
         ...
         $("#parents").change(function() {
            ...
            /*if ((parent1inc == "earned") && (parent2inc == "earned")){
                     $("#pttype").html('<label for="earned1">Earned income for Parent 1: </label><input type="text" id="earned1" />');
                     $("#pttype2").html('<label for="earned2">Earned income for Parent 2: </label><input type="text" id="earned2" />');
               
                        }
                         
            else if ((parent1inc == "earned") && (parent2inc == "unearned")){
                     $("#pttype").html('<label for="earned1">Earned income for Parent 1: </label><input type="text" id="earned1" />');
                    $("#pttype2").html('<label for="unearned2">Unearned income for Parent 2: </label><input type="text" id="unearned2" />');
               
                        }
            else if ((parent1inc == "unearned") && (parent2inc == "unearned")){
                     $("#pttype").html('<label for="unearned1">Unearned income for Parent 1: </label><input type="text" id="unearned1" required />');
                     $("#pttype2").html('<label for="unearned2">Unearned income for Parent 2: </label><input type="text" id="unearned2" required />');
               
                        }
            else if ((parent1inc == "unearned") && (parent2inc == "earned")){
                     $("#pttype").html('<label for="unearned1">Unearned income for Parent 1: </label><input type="text" id="unearned1" />');
                       $("#pttype2").html('<label for="earned2">Earned income for Parent 2: </label><input type="text" id="earned2" />');
               
                        }
                          
            else if ((parent1inc == "unearned") && (parent2inc == "none")){
                     $("#pttype").html('<label for="unearned1">Unearned income for Parent 1: </label><input type="text" id="unearned1" />');
                     $("pttype2").html('');
               
                        }
                          
            else if ((parent1inc == "earned") && (parent2inc == "none")){
                     $("#pttype").html('<label for="earned1">Earned income for Parent 1: </label><input type="text" id="earned1" />');
                     $("#pttype2").html('');
               
                        }
                          
            else if ((parent1inc == "none") && (parent2inc == "earned")){
                     $("#pttype").html('');
                     $("#pttype2").html('<label for="earned2">Earned income for Parent 2: </label><input type="text" id="earned2" />');
               
                        }
    
            else if ((parent1inc == "none") && (parent2inc == "none")){
                     $("#pttype").html('');
                     $("#pttype2").html('');
...
function calculation() {
        ...
        function both(earned, unearned) {
            ...
            both1 = ((unearned1 - 20) + (earned1 - 65)/2) - fbr;
...
//state la code
/*var statelaField = document.getElementById("state_supp");
var s = statelaField.selectedIndex;
var statelacode = statelaField.options[s].value;*/
                ...
                if (parents == 0) {
                    ...
                    document.getElementById("deeming").value = (0.00).toFixed(2);
                            ...
                            if (type_of_incomeQues == "unearned") {
                                    ...
                                    document.getElementById("fci").value = unearned - 20;
                                    ...
                                    document.getElementById("fci").value = (earned - 85)/2;
                                    document.getElementById("ssipay").value = (payment - document.getElementById("fci").value);
                                    ...
                                    both();
                                                ...
                                                if (both){
                                                        ...
                                                        document.getElementById('fci').value = both;
                                                        document.getElementById("ssipay").value = payment - both; document.getElementById('fci').value;
        ...
        //one parent living in the household
                ...
                var ineligibles = ineligible_child_field.options[c].value;
                            ...
                            if ((parent_income == "unearned") && (type_of_incomeQues == "unearned")) {
                                ...
                                document.getElementById("deeming").value = (((earnedpt1 - 65)/2) - fbr - (ineligibles * allocation)).toFixed(2);
                                document.getElementById("fci").value = (((earned - 85)/2) + (document.getElementById("deeming").value - 20)).toFixed(2);
                                document.getElementById("ssipay").value = (payment - document.getElementById("fci").value).toFixed(2);
                                ...
                                var unearned = unearnedField.value;
                                    ...
                                    if ((both1) && (unearned)){
                                                        document.getElementById("deeming").value = (both1 - (ineligibles * allocation)).toFixed(2);
                                                        document.getElementById('fci').value = ((unearned - 20) + (document.getElementById("deeming").value - 20)).toFixed(2);
                                                        document.getElementById("ssipay").value = (payment - document.getElementById("fci").value).toFixed(2); 
...
//        document.getElementById("fci").value = document.getElementById("deeming").value - 20;
   ...
   //negates the result above only if it is a negative number
    ...
    /*if (document.getElementById("fci").value <= 0){
        ...
        document.getElementById("fci").value = 0;
        document.getElementById("ssipay").value = payment;
    }

    else {


        document.getElementById("fci").value = document.getElementById("fci").value;
        document.getElementById("ssipay").value = payment - document.getElementById("fci").value;
    ...
    /*if (document.getElementById("deeming").value <= 0) {
        ...
        document.getElementById("deeming").value = document.getElementById("deeming").value;
    }*/
